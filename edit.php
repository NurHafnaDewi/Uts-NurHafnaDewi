        ...
        <div class="card-body">
            ...
            <form action="update.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="semester" value="<?= $d['semester']; ?>" class="form-control" required>
                </div>

                <div class="mb-3">
                    <label>Mata Kuliah</label>
                    <input type="text" name="matakuliah" value="<?= $d['matakuliah']; ?>" class="form-control" required>
                </div>

                <div class="mb-3">
                    <label>Nilai</label>
                    <input type="number" name="nilai" value="<?= $d['nilai']; ?>" class="form-control" required>
                </div>
